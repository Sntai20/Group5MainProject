...
public class QueryRunner
{
    ...
    public QueryRunner()
    {
        ...
        this.m_projectTeamApplication="QueryRunner";    // THIS NEEDS TO CHANGE FOR YOUR APPLICATION
    ...
    public static void main(String[] args) {
        ...
        else
        {
            if (args[0].equals ("-console"))
            {
                ...
                String username;
                String password;
                String databasename = "mm_cpsc502102team05"; //this is to print proper welcome message.
